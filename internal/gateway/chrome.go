...
const (
	...
	moviesFavicon = `data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2064%2064'%3E%3Crect%20width='64'%20height='64'%20rx='14'%20fill='%23120a1a'/%3E%3Crect%20x='5'%20y='5'%20width='54'%20height='54'%20rx='11'%20fill='none'%20stroke='%23ff4f70'%20stroke-width='2'/%3E%3Cpath%20d='M12%2024h40v26a3%203%200%2001-3%203H15a3%203%200%2001-3-3z'%20fill='%23f4f1e8'/%3E%3Cpath%20d='M12%2016l4-8h7l-4%208zm12%200l4-8h7l-4%208zm12%200l4-8h6l-4%208z'%20fill='%23ff4f70'/%3E%3Crect%20x='12'%20y='16'%20width='40'%20height='8'%20fill='%23120a1a'/%3E%3C/svg%3E`
)
...
func gameFaviconMarkup(prefix string) string {
	...
	case "/play/movie-selector":
		name, favicon = "movies", moviesFavicon
	default:
